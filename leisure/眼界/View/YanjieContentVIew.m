...
@implementation YanjieContentVIew
...
- (instancetype)initWithFrame:(CGRect)frame Width:(CGFloat)width model:(YanJieModel *)model collor:(UIColor *)collor{
    ...
    if (self) {
        ...
        _collectionCustom = [[YanJieCustomView alloc]initWithFrame:CGRectMake(5, y, (kWidth - 10) / 4, 30) Width:width LabelString:model.collectionCount collor:collor];
        [self addSubview:_collectionCustom];
        
        _shareCustom = [[YanJieCustomView alloc]initWithFrame:CGRectMake((kWidth - 10) / 4 + 5, y, (kWidth - 10) / 4, 30) Width:width LabelString:model.shareCount collor:collor];
        [self addSubview:_shareCustom];
        _cacheCustom = [[YanJieCustomView alloc]initWithFrame:CGRectMake(_shareCustom.frame.origin.x + _shareCustom.frame.size.width, y, (kWidth - 10) / 4, 30) Width:width LabelString:@"缓存" collor:collor];
        [self addSubview:_cacheCustom];
        _replyCustom = [[YanJieCustomView alloc]initWithFrame:CGRectMake(_cacheCustom.frame.origin.x + _cacheCustom.frame.size.width, y, (kWidth - 10) / 4, 30) Width:width LabelString:model.replyCount collor:collor];
