...
- (void)viewDidLoad {
    ...
    UILabel *title1 = [Factory createLabelWithTitle:@"听说" frame:CGRectMake(100, 8, ScreenWidth-40, 30)];
    [self.navigationController.navigationBar addSubview:title1];
    title1.font = [UIFont boldSystemFontOfSize:18.f];
