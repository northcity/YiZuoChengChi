...
//        gradientLayerLeft.shadowOpacity = 0.1f;
       ...
       nameLabel.font = [UIFont fontWithName:@"Wyue-GutiFangsong-NC" size:20];
...
//        [cell.contentView.layer insertSublayer:subLayerIcon below:imageViewPingGuo.layer];
    ...
    if (indexPath.row == 4) {
        ...
        [ self.lianJieBtn addTarget:self action:@selector(awakeSelfApp) forControlEvents:UIControlEventTouchUpInside];
        ...
        if ([[UIApplication sharedApplication] canOpenURL:myURL_APP_A]) {
            NSLog(@"canOpenURL");
            [ self.lianJieBtn setTitle:@"去评价" forState:UIControlStateNormal];
        }else{
            NSLog(@"不显示");
            [ self.lianJieBtn setTitle:@"去评价" forState:UIControlStateNormal];
        }
    ...
    if (indexPath.row == 3) {
        ...
        [Button addTarget:self action:@selector(awakeOtherApp) forControlEvents:UIControlEventTouchUpInside];
    }
...
//        NSString * url = [NSString stringWithFormat:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=%@",@"1353019343"];
//
//        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:url]];
//
    
//    NSString *str = [NSString stringWithFormat: @"itms-apps://ax.itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=%d",1353019343 ];
    
    NSString *str = [NSString stringWithFormat:@"http://itunes.apple.com/us/app/id%d", 1353019343];
