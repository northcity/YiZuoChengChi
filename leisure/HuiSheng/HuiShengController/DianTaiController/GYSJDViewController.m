...
#define GYSJDURL @"http://www.duole.fm/api/collect/get_sound_list?collect_id=%@&limit=20&sort=1&page=1&visitor_uid=256492&only_id=0&device=android&app_version=23"


@interface GYSJDViewController ()<UITableViewDataSource,UITableViewDelegate,SDCycleScrollViewDelegate>
...
@implementation GYSJDViewController
...
- (void)getNetData
{
    ...
    NSString *url = [NSString stringWithFormat:GYSJDURL,self.model.pageID];
