...
@interface TKXViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation TKXViewController
...
- (void)getNetData
{
    ...
    NSString *url = [NSString stringWithFormat:TKXURL,self.page];
    //NSLog(@"%@",url);
...
{
    LXSMModel *model = self.dataSource[indexPath.row];
    TKXDViewController *lmc = [[TKXDViewController alloc]initWithModel:model];
